...
describe('Test example', () => {
  ...
  it('Navigate to Top voluntari page', () => {
    ...
    cy.get('h5[class="title"]').should ('contain',"Vizualizare nevoie recomandata") 
    ...
    cy.get('span[class="vs__selected"]').should('exist')
    cy.get('textarea[name="description"]').should('exist')
    cy.get('input[placeholder*="strada"]').should('exist')
